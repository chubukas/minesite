...
<li class="active" data-toggle="modal" data-target="#myModal" >
    <a class="" href="deposit">
           <i class="fa fa-btc icon-wrap"></i>
           <span class="mini-click-non">Deposit</span>
        </a>
</li>
...
<li class="active">
    <a class="" href="withdraw">
           <i class="fa fa-money icon-wrap"></i>
           <span class="mini-click-non">Withdraw</span>
        </a>
</li>
...
<li class="active">
    <a class="" href="transfer">
           <i class="fa fa-money icon-wrap"></i>
           <span class="mini-click-non">Transfer</span>
        </a>
</li>
...
<!-- <li class="active">
    <a class="" href="walletsettings">
           <i class="fa fa-cog icon-wrap"></i>
           <span class="">Wallet settings</span>
        </a>
</li> -->
