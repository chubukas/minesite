<?php include 'inc/head.php'; ?>
    ...
    <section class="main">
        <div class="container">
            <h1>Cookie Policy for CrypticCapitals</h1>
            <p>This is the Cookie Policy for CrypticCapitals, accessible from <a href="index" target="_blank">crypticcapitals.com</a></p>
            <h4 style="margin-bottom:10px;">What Are Cookies?</h4>
            ...
            <ul style="margin-bottom:25px;">
                ...
                <li>Orders processing related cookies.<br/>
                    This site offers e-commerce or payment facilities and some cookies are essential to ensure that your order is remembered between pages so that we can process it properly.</li>
                <li>Site preferences cookies.<br/>
                    In order to provide you with a great experience on this site we provide the functionality to set your preferences for how this site runs when you use it. In order to remember your preferences we need to set cookies so that this information can be called whenever you interact with a page is affected by your preferences.
                </li>
            </ul>
            <h4 style="margin-bottom:10px;">Third Party Cookies</h4>
            ...
            <p>Hopefully that has clarified things for you and as was previously mentioned if there is something that you aren't sure whether you need or not it's usually safer to leave cookies enabled in case it does interact with one of the features you use on our site.
                ...
                <a href="mailto:info@crypticcapitals.com">info@crypticcapitals.com</a>
            </p>
        </div>
    </section>
